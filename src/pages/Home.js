...
const Robot = () => (
  <svg width="180" height="180" viewBox="0 0 200 200">
    ...
    <circle cx="75" cy="90" r="15" fill="#FFD700" />
    <circle cx="125" cy="90" r="15" fill="#FFD700" />
...
const AIWorld = () => (
  <svg width="80" height="80" viewBox="0 0 120 120">
    <rect x="25" y="30" width="70" height="60" rx="16" fill="#FFD700" stroke="#333" strokeWidth="2" />
    <line x1="60" y1="20" x2="60" y2="30" stroke="#333" strokeWidth="3" />
    <circle cx="60" cy="18" r="5" fill="#8A2BE2" />
...
const MLWorld = () => (
  <svg width="80" height="80" viewBox="0 0 120 120">
    ...
    <circle cx="25" cy="30" r="8" fill="#FFD700" /><circle cx="25" cy="60" r="8" fill="#FFD700" /><circle cx="25" cy="90" r="8" fill="#FFD700" />
    <circle cx="60" cy="25" r="8" fill="#8A2BE2" /><circle cx="60" cy="60" r="8" fill="#8A2BE2" /><circle cx="60" cy="95" r="8" fill="#8A2BE2" />
    <circle cx="95" cy="45" r="10" fill="#6A0DAD" />
  </svg>
);

const RoboticsWorld = () => (
  <svg width="80" height="80" viewBox="0 0 120 120">
    <rect x="45" y="30" width="30" height="50" rx="6" fill="#6A0DAD" />
    <circle cx="60" cy="40" r="6" fill="#fff"/>
    <circle cx="60" cy="60" r="6" fill="#fff"/>
    <rect x="30" y="50" width="10" height="30" rx="4" fill="#8A2BE2"/>
    <rect x="80" y="50" width="10" height="30" rx="4" fill="#8A2BE2"/>
...
const Home = () => {
  ...
  const topics = [
    { name: "AI World", desc: "Machines that can think and help", image: <AIWorld />, accent: "#FFD700", route: "ai" },
    { name: "ML World", desc: "Machines that learn from examples", image: <MLWorld />, accent: "#8A2BE2", route: "ml" },
    { name: "Robotics", desc: "Machines that can move and work", image: <RoboticsWorld />, accent: "#D4A017", route: "robotics" },
  ];
      ...
      <section className="hero-section">
        ...
        <div className="hero-wave">
          <svg viewBox="0 0 1440 100" preserveAspectRatio="none">
            <path d="M0,60 C360,120 1080,0 1440,60 L1440,100 L0,100Z" fill="#ffffff"/>
          </svg>
        </div>
      </section>
